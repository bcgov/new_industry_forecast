...
#' for some reason extra column added when writing to disk, and then appended
#' to industry when read. The extract step below splits industry on the last
#' comma... should fix this bug after forecasting done. 
