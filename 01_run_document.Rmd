...
#' 
#' TO DO: remove the +1 on line 121 (once current driver data available)
...
historic_start <- 2010
historic_end <- 2019
colors <- c("Employment" = "black", "Last Year" = "purple", "New Forecast" = "orange", "Driver Data" = "blue", "Forecast Already" = "red", "CAGR Forecast"="aquamarine")
...
# make forecast, where the forecast grows at the 2010-2019 CAGR.
...
driver_data <- read_csv(here("data","current","driver_data_2024.csv"))%>%
...
selectInput(
  ...
  c("Last Year","Driver","CAGR Forecast"),
  selected = "Last Year"
)
...
renderPlot({
  ggplot(mapping=aes(year,value)) +
    geom_line(data = reactive_employment(), mapping = aes(colour = "Employment"), lwd = 2) +
    geom_line(data = reactive_driver(), mapping = aes(colour = "Driver Data"), lwd = 3) +
    geom_line(data = reactive_CAGR_forecast(), mapping = aes(colour = "CAGR Forecast"), lwd = 3) +
    geom_line(data = reactive_old(), mapping = aes(colour = "Last Year"), lwd = 2) +
    geom_line(data = reactive_new(), mapping = aes(colour = "New Forecast"), lwd = 2) +
    geom_line(data = reactive_already(), mapping = aes(colour = "Forecast Already"), lwd = 2) +
