...
reactive_new <- reactive({
  ...
  adjustments <- tibble(year = forecast_years, 
                        ...
                        curvature =  case_when(input$curvature==0 ~ 1,
                                               input$curvature>0 ~ (1-(abs(forecast_years-mean(forecast_years))/(1001-abs(input$curvature)))^2),
                                               input$curvature<0 ~ ((abs(forecast_years-mean(forecast_years))/(1001-abs(input$curvature)))^2+1)),
